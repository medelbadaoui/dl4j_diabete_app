...
public class DiabeteApp {
    public static void main(String[] args) throws Exception{
       ...
       // System.out.println(configuration.toJson());
        ...
        File fileTrain=new ClassPathResource("DiabeteTrain.csv").getFile();
        ...
        File fileTest=new ClassPathResource("DiabeteTest.csv").getFile();
        ...
        ModelSerializer.writeModel(model,"DiabeteModel.zip",true);
